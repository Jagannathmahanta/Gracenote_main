...
function SingleComedy({title,preferredImage,id,topCast,releaseYear,descriptionLang
...
<>
    ...
    <Container className='movies-list'>
      ...
      <Content className='card-container'>
        <Warp className='card'onClick={()=>handleImage(id)}>
